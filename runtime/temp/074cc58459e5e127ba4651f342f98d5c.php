                    ...
                    <div class="widget-body">
                        <fieldset>
                            ...
                            <div class="am-form-group">
                                <label class="am-u-sm-2 am-form-label form-require"> 权限名称 </label>
                                <div class="am-u-sm-10">
                                    <input type="text" class="tpl-form-input" name="name" maxlength="30" value="<?php echo htmlentities($data['name']); ?>">
                                </div>
                            </div>
                            <div class="am-form-group">
                                <label class="am-u-sm-2 am-form-label form-require"> 权限配置 </label>
                                <div class="am-u-sm-10"><?php echo $htmlPower; ?></div>
                            </div>
                            <div class="am-form-group">
                            ...
                            <div class="am-form-group">
                                <div class="am-u-sm-10 am-u-sm-push-2 am-margin-top-lg">
                                    ...
                                    <button id="btn-submit" type="button" class="j-submit am-btn am-btn-secondary" onclick="TF_Role._submit('<?php echo htmlentities($workUrl); ?>')">确认提交</button>
                                </div>
                            </div>
                            <?php endif; ?>
                        </fieldset>
