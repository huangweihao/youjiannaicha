                    ...
                    <div class="am-u-sm-12 am-u-md-9 page_toolbar">
                        <div class="am fr ">
                            <form method="get" name="search" action="<?php echo htmlentities($searchUrl); ?>">
                                <?php echo $statusSelectStr; ?>
                            <div class="am-form-group am-fl">
                                <div class="am-input-group am-input-group-sm tpl-form-border-form">
                                    <input type="text" class="am-form-field" name="sword" placeholder="请输入活动名称" value="<?php echo htmlentities($searchWord); ?>">
                    ...
                    <div class="am-scrollable-horizontal am-u-sm-12">
                        <table width="100%" class="am-table am-table-compact am-table-striped tpl-table-black am-text-nowrap">
                            ...
                            <tr>
                                ...
                                <td class="am-text-middle"><?php echo htmlentities($item['address']); ?></td>
                                <td class="am-text-middle"><?php echo htmlentities($item['begin_time']); ?></td>
                                <td class="am-text-middle"><?php echo htmlentities($item['end_time']); ?></td>
                                <td class="am-text-middle"><?php echo htmlentities($item['join_begin']); ?></td>
                                <td class="am-text-middle"><?php echo htmlentities($item['join_end']); ?></td>
                                ...
                                <td class="am-text-middle">
                                    <div class="tpl-table-black-operation">
                                        ...
                                        <?php endif; ?>
                                        <a href="<?php echo htmlentities($schedulUrl); ?><?php echo htmlentities($item['id']); ?>">
                                            <i class="am-icon-file-text-o"></i> 排班
                                        </a>
                                        <a href="<?php echo $showUrl; ?>" data-i="<?php echo htmlentities($item['id']); ?>" data-n="<?php echo htmlentities($item['title']); ?>-排班列表">
                                            <i class="am-icon-file-text-o"></i> 排班列表
                                        </a>
                                    </div>
                                </td>
                            </tr>
