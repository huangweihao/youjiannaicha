<?php /*a:4:{s:80:"/Users/huang/Documents/project/jining/xingzhengguanli/app/view/schedule/work.tpl";i:1604236611;s:73:"/Users/huang/Documents/project/jining/xingzhengguanli/app/view/layout.tpl";i:1604367739;s:87:"/Users/huang/Documents/project/jining/xingzhengguanli/app/view/upload/tpl_file_item.tpl";i:1590067177;s:86:"/Users/huang/Documents/project/jining/xingzhengguanli/app/view/upload/file_library.tpl";i:1590067177;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    <meta charset="utf-8"/>
                    ...
                    <div class="widget-body">
                        <fieldset>
                            <div class="widget-head am-cf">
                                <div class="widget-title am-fl"><?php echo htmlentities($columnName); ?>排班</div>
                            </div>
                            <div class="am-form-group">
                                <label class="am-u-sm-2 am-form-label form-require"> 活动标题 </label>
                                <div class="am-u-sm-10">
                                    <input type="text" class="tpl-form-input" readonly name="title"  value="<?php echo htmlentities($data['title']); ?>">
                                </div>
                            </div>
                            <div class="am-form-group">
                                <label class="am-u-sm-2 am-form-label form-require"> 举办地址 </label>
                                <div class="am-u-sm-10">
                                    <input type="text" class="tpl-form-input" readonly name="address"  value="<?php echo htmlentities($data['address']); ?>">
                                </div>
                            </div>
                            ...
                            <div class="am-form-group">
                                ...
                                <div class="am-u-sm-10" style="position: sticky;">
                                    <textarea  class="tpl-form-input" id="activity" name="content" ><?php echo htmlentities($data['content']); ?></textarea>
                                </div>
                            </div>
                            <div class="am-form-group">
                                <label class="am-u-sm-2 am-form-label form-require"> 开始时间 </label>
                                <div class="am-u-sm-10">
                                    <input type="text" id="picker_begin_time" readonly class="tpl-form-input"  name="begin_time"  value="<?php echo htmlentities($data['begin_time']); ?>">
                                </div>
                            </div>
                            <div class="am-form-group">
                                <label class="am-u-sm-2 am-form-label form-require"> 结束时间 </label>
                                <div class="am-u-sm-10">
                                    <input type="text" id="picker_end_time" readonly class="tpl-form-input" name="end_time"  value="<?php echo htmlentities($data['end_time']); ?>">
                                </div>
                            </div>
                            <div class="am-form-group">
                                <label class="am-u-sm-2 am-form-label form-require"> 排班标题 </label>
                                <div class="am-u-sm-10">
                                    <input type="text"  class="tpl-form-input" readonly  value="<?php echo htmlentities($data['schedule_title']); ?>" name="schedule_title" >
                                </div>
                            </div>
                            <div class="am-form-group">
                                <label class="am-u-sm-2 am-form-label form-require"> 排班开始时间 </label>
                                <div class="am-u-sm-10">
                                    <input type="text" id="picker_schedule_begin" readonly  class="tpl-form-input" value="<?php echo htmlentities($data['schedule_begin']); ?>"  name="schedule_begin" >
                                </div>
                            </div>
                            <div class="am-form-group">
                                <label class="am-u-sm-2 am-form-label form-require"> 排班结束时间 </label>
                                <div class="am-u-sm-10">
                                    <input type="text" id="picker_schedule_end" readonly  class="tpl-form-input" value="<?php echo htmlentities($data['schedule_end']); ?>" name="schedule_end" >
                                </div>
                            </div>
                            <div class="am-form-group">
                                <label class="am-u-sm-2 am-form-label form-require"> 选择用户 </label>
                                <div class="am-u-sm-10">
                                    <button style="margin-left: 10px;" type="button" disabled onclick="TB_Common._OpenBig(this,'/user/choose')" data-i="<?php echo htmlentities($data['activity_id']); ?>" data-n="排班" class="am-btn am-btn-success">选择用户</button>
                                </div>
                            </div>
                            <div class="am-form-group">
                                <lable class="am-u-sm-2 am-form-label"></lable>
                                <div class="am-u-sm-10" id="chooseShowUser">
                                    <?php if(!empty($data['users'])): foreach($data['users'] as $item): ?>
                                            <div style="margin-left: 10px;" class="am-btn am-btn-success"><?php echo htmlentities($item); ?></div>
                                        <?php endforeach; ?>
                                    <?php endif; ?>
                                </div>
                                <input type="hidden" name="user_id" value="<?php echo htmlentities($data['user_id']); ?>" id="chooseUser">
                            </div>
                            <?php if($columnPower['insert'] || $columnPower['update']): ?>
                            <div class="am-form-group">
                                <div class="am-u-sm-10 am-u-sm-push-2 am-margin-top-lg">
                                    <input type="hidden" name="activity_id" value="<?php echo htmlentities($data['activity_id']); ?>">
                                    <input type="hidden" name="key" value="<?php echo htmlentities($data['id']); ?>">
                                    <button id="btn-submit" disabled type="button" class="j-submit am-btn am-btn-secondary" onclick="TF_Schedule._submit('<?php echo htmlentities($workUrl); ?>')">确认提交</button>
                                </div>
                            </div>
                            <?php endif; ?>
                        </fieldset>
...
<?php endif; if(in_array($columnController,['Train','ThirdpartyUser','Lesson','Schedule','Lesson','VolunteerActivity','Shop','ActivityTemplate','Huibendi']) && in_array($columnAction,['i','e','show'])): ?>
    <script>
