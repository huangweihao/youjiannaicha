                    ...
                    <div class="am-scrollable-horizontal am-u-sm-12" >
                        <table width="100%" class="am-table am-table-compact am-table-striped tpl-table-black am-text-nowrap">
                            ...
                            <tr>
                                ...
                                <td class="am-text-middle"><?php echo !empty($managerData[$item['manager_id']]) ? htmlentities($managerData[$item['manager_id']]) : '-'; ?></td>
                                <td class="am-text-middle"><?php echo htmlentities(long2ip($item['ip'])); ?></td>
