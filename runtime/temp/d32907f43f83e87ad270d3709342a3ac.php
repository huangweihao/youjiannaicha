...
<div class="tpl-content-wrapper">
    ...
    <div class="am-u-sm-12 am-u-md-12 am-u-lg-12 main_page_bg am-padding-lg">
        <div class="am-u-sm-3 am-text-right" style="font-size: 150px; padding-right: 30px">
            <i class="<?php echo htmlentities($noticeIcon); ?>"></i>
        </div>
        <div class="am-u-sm-9 am-padding-left-lg" style="padding-top: 70px">
            <h2><?php echo $noticeTitle; ?></h2>
            <p><?php echo htmlentities($noticeMsg); ?></p>
            <?php if(!empty($msg)): ?><p><?php echo htmlentities($msg); ?></p><?php endif; ?>
            <p>&nbsp;</p>
            <a href="javascript:void(0);" onclick="history.back(-1);">[返回上一步]</a> <?php if(!empty($url)): ?><a href="<?php echo htmlentities($url); ?>">[跳转指定页面]</a><?php endif; ?></p>
        </div>
    </div>
</div>
</div>
