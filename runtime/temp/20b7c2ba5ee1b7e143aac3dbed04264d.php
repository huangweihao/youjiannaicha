                    ...
                    <div class="widget-body">
                        <fieldset>
                            ...
                            <div class="am-form-group">
                                ...
                                <div class="am-u-sm-10">
                                    <input type="text" class="tpl-form-input" name="age" maxlength="30" value="<?php echo htmlentities($data['age']); ?>">
                                </div>
                            </div>
                            <div class="am-form-group">
                                <label class="am-u-sm-2 am-form-label form-require"> 健康状况 </label>
                                <div class="am-u-sm-10">
                                    <input type="radio" value="1" name="health" <?php if($data['health'] == 1): ?> checked<?php endif; ?>> 健康
                                    <input type="radio" value="2" name="health" <?php if($data['health'] == 2): ?> checked<?php endif; ?>> 一般(无慢性、传染性疾病)
                                    <input type="radio" value="3" name="health" <?php if($data['health'] == 3): ?> checked<?php endif; ?>> 体弱(无慢性、传染性疾病)
                                    <input type="radio" value="4" name="health" <?php if($data['health'] == 4): ?> checked<?php endif; ?>> 有无慢性、传染性疾病)
                            ...
                            <div class="am-form-group">
                                ...
                                <div class="am-u-sm-10">
                                    <label class="am-radio-inline">
                                        <input type="radio" value="1" name="status"<?php if($data['status'] == 1): ?> checked<?php endif; ?>> 正常
                                    </label>
                                    <label class="am-radio-inline">
                                        <input type="radio" value="0" name="status"<?php if($data['status'] == 0): ?> checked<?php endif; ?>> 未审核
                                    </label>
                                    <label class="am-radio-inline">
                                        <input type="radio" value="2" name="status"<?php if($data['status'] == 2): ?> checked<?php endif; ?>> 未通过审核
                                    </label>
                                    <label class="am-radio-inline">
                                        <input type="radio" value="3" name="status"<?php if($data['status'] == 3): ?> checked<?php endif; ?>> 黑名单
                                    </label>
                                </div>
                            </div>
