<?php /*a:4:{s:80:"/Users/huang/Documents/project/jining/xingzhengguanli/app/view/organize/work.tpl";i:1603940008;s:73:"/Users/huang/Documents/project/jining/xingzhengguanli/app/view/layout.tpl";i:1604411209;s:87:"/Users/huang/Documents/project/jining/xingzhengguanli/app/view/upload/tpl_file_item.tpl";i:1590067177;s:86:"/Users/huang/Documents/project/jining/xingzhengguanli/app/view/upload/file_library.tpl";i:1590067177;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    <meta charset="utf-8"/>
                    ...
                    <div class="widget-body">
                        <fieldset>
                            ...
                            <div class="am-form-group">
                                <label class="am-u-sm-2 am-form-label form-require"> 组织名 </label>
                                <div class="am-u-sm-10">
                                    <input type="text" class="tpl-form-input" name="name" maxlength="6" value="<?php echo htmlentities($data['name']); ?>">
                                </div>
                            </div>
                            <div class="am-form-group">
                            ...
                            <div class="am-form-group">
                                <div class="am-u-sm-10 am-u-sm-push-2 am-margin-top-lg">
                                    ...
                                    <button id="btn-submit" type="button" class="j-submit am-btn am-btn-secondary" onclick="TF_Organize._submit('<?php echo htmlentities($workUrl); ?>')">确认提交</button>
                                </div>
                            </div>
                            <?php endif; ?>
                        </fieldset>
...
<?php endif; if(in_array($columnController,['Train','ThirdpartyUser','Lesson','Schedule','Lesson','VolunteerActivity','Shop','Article','Huibendi']) && in_array($columnAction,['i','e','show','schedule'])): ?>
    <script>
...
<script id="tpl-group-item" type="text/template">
    ...
    <script>
        <?php if(in_array($columnController,['Train','Lesson','ThirdpartyUser','Schedule','VolunteerActivity','Article']) && in_array($columnAction,['i','e','show','schedule'])): ?>
        $(function () {
            UM.getEditor('remark', {
