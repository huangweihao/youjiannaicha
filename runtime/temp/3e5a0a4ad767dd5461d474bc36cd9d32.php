                    ...
                    <div class="widget-body">
                        <fieldset>
                            ...
                            <div class="am-form-group">
                                ...
                                <div class="am-u-sm-9 am-u-end"><?php echo $roleSelectStr; ?></div>
                            </div>
                            <div class="am-form-group">
                                <label class="am-u-sm-3 am-u-lg-2 am-form-label form-require">管理员名称 </label>
                                <div class="am-u-sm-9 am-u-end">
                                    <input type="text" class="tpl-form-input" name="username" value="<?php echo htmlentities($data['name']); ?>" placeholder="请输入操作人名">
                                </div>
                            </div>
                            <div class="am-form-group">
                            ...
                            <div class="am-form-group">
                                ...
                                <div class="am-u-sm-10">
                                    ...
                                    <label class="am-radio-inline">
                                        <input type="radio" value="0" name="status"<?php if($data['status'] == 0): ?> checked<?php endif; ?>> 锁定
                                    </label>
                                </div>
                            </div>
                            ...
                            <div class="am-form-group">
                                <div class="am-u-sm-9 am-u-sm-push-3 am-margin-top-lg">
                                    ...
                                    <button type="button" onclick="TF_Manager._submit('<?php echo htmlentities($workUrl); ?>')" class="j-submit am-btn am-btn-secondary">确认提交
                                    </button>
                                </div>
                            </div>
                            <?php endif; ?>
