                        ...
                        <div class="am fr ">
                            ...
                            <div class="am-form-group am-fl">
                                <div class="am-input-group am-input-group-sm tpl-form-border-form">
                                    <input type="text" class="am-form-field" name="sword" placeholder="请输入广告类型" value="<?php echo htmlentities($searchWord); ?>">
