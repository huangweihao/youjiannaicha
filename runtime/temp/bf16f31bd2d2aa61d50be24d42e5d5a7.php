                    ...
                    <div class="widget-body">
                        <fieldset>
                            ...
                            <div class="am-form-group">
                                <label class="am-u-sm-2 am-form-label form-require"> 等级名称 </label>
                                <div class="am-u-sm-10">
                                    <input type="text" class="tpl-form-input" name="title"  value="<?php echo htmlentities($data['title']); ?>">
                                </div>
                            </div>
                            <div class="am-form-group">
                                <label class="am-u-sm-2 am-form-label"> 等级描述 </label>
                                <div class="am-u-sm-10">
                            ...
                            <div class="am-form-group">
                                <div class="am-u-sm-10 am-u-sm-push-2 am-margin-top-lg">
                                    ...
                                    <button id="btn-submit" type="button" class="j-submit am-btn am-btn-secondary" onclick="TF_Level._submit('<?php echo htmlentities($workUrl); ?>')">确认提交</button>
                                </div>
                            </div>
                            <?php endif; ?>
                        </fieldset>
