            ...
            <div class="widget am-cf">
                ...
                <div class="widget-body am-fr">
                    ...
                    <div class="am-u-sm-12 am-u-md-9 page_toolbar">
                        <div class="am fr">
                            <form method="get" class="sub" name="search" action="<?php echo htmlentities($searchUrl); ?>">
                            <?php echo $roleSelectStr; ?>
                            <div class="am-form-group am-fl">
                                <div class="am-input-group am-input-group-sm tpl-form-border-form">
                                    <input type="text" class="am-form-field" name="sword" placeholder="请输入管理员名称" value="<?php echo htmlentities($searchWord); ?>">
                        ...
                        <table width="100%" class="am-table am-table-compact am-table-striped tpl-table-black am-text-nowrap">
                            ...
                            <?php foreach($data['data'] as $key=>$item): ?>
                                <tr>
                                    ...
                                    <td class="am-text-middle"><input type="checkbox" name="chk" value="<?php echo htmlentities($item['id']); ?>"<?php if($item['id']==1): ?> disabled<?php endif; ?>></td>
                                    <td class="am-text-middle"><?php echo htmlentities($item['name']); ?></td>
                                    <td class="am-text-middle"><?php echo !empty($roleData[$item['role_id']]) ? htmlentities($roleData[$item['role_id']]) : '-'; ?></td>
                                    <td class="am-text-middle"><?php if($item['ctime'] == '0'): ?>-<?php else: ?><?php echo htmlentities(date('Y-m-d H:i',!is_numeric($item['ctime'])? strtotime($item['ctime']) : $item['ctime'])); ?><?php endif; ?></td>
                                    <td class="am-text-middle"><?php if($item['utime'] == '0'): ?>-<?php else: ?><?php echo htmlentities(date('Y-m-d H:i',!is_numeric($item['utime'])? strtotime($item['utime']) : $item['utime'])); ?><?php endif; ?></td>
                                    <td class="am-text-middle"><?php echo $item['status']==1 ? '<span class="am-text-success">正常</span>' : '<span class="am-text-danger">锁定</span>'; ?></td>
                                    <td class="am-text-middle">
                                        <div class="tpl-table-black-operation">
                                            ...
                                            <?php endif; if($columnPower['other']): ?>
                                            <a href="<?php echo $logOpenUrl; ?>" data-i="<?php echo htmlentities($item['id']); ?>" data-n="<?php echo htmlentities($item['name']); ?>-登录详情">
                                                <i class="am-icon-file-text-o"></i> 登录
                                            </a>
                                            <?php endif; ?>
                                        </div>
                                    </td>
