                    ...
                    <div class="widget-body">
                        <fieldset>
                            ...
                            <div class="am-form-group">
                                ...
                                <div class="am-u-sm-10">
                                    <button style="margin-left: 10px;" type="button" onclick="TB_Common._OpenBig(this,'/user/choose')" data-i="<?php echo htmlentities($data['id']); ?>" data-n="排班" class="am-btn am-btn-success">选择用户</button>
                                </div>
                            </div>
                            <div class="am-form-group">
                            ...
                            <div class="am-form-group">
                                <div class="am-u-sm-10 am-u-sm-push-2 am-margin-top-lg">
                                    <input type="hidden" name="activity_id" value="<?php echo htmlentities($data['id']); ?>">
                                    <button id="btn-submit" type="button" class="j-submit am-btn am-btn-secondary" onclick="TF_Schedule._submit('<?php echo htmlentities($workUrl); ?>')">确认提交</button>
                                </div>
                            </div>
                            <?php endif; ?>
                        </fieldset>
