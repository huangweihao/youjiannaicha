                                ...
                                <div class="am-form-group am-fl">
                                    <div class="am-input-group am-input-group-sm tpl-form-border-form">
                                        <div class="am-input-group-btn">
                                            <a target="_self" href="<?php echo htmlentities($excelUrl); ?>" style="background: #4db14d;color: #ffffff;float: right;" class="am-btn am-btn-default am-btn-secondary" type="button">导出数据</a>
                                        </div>
                                    </div>
                                </div>
                            <div class="am-form-group am-fl">
