                        ...
                        <fieldset>
                            ...
                            <div class="am-form-group">
                                ...
                                <div class="am-u-sm-10">
                                    <input type="text" class="tpl-form-input" readonly name="username" maxlength="6" value="<?php echo htmlentities($data['username']); ?>">
                                </div>
                            </div>
                            <div class="am-form-group">
                                <label class="am-u-sm-2 am-form-label form-require"> 手机号 </label>
                                <div class="am-u-sm-10">
                                    <input type="text" class="tpl-form-input" readonly name="phone" maxlength="30" value="<?php echo htmlentities($data['phone']); ?>">
                                </div>
                            </div>
                            <div class="am-form-group">
                                <label class="am-u-sm-2 am-form-label form-require"> 身份证 </label>
                                <div class="am-u-sm-10">
                                    <input type="text" class="tpl-form-input" readonly name="identity" maxlength="30" value="<?php echo htmlentities($data['identity']); ?>">
                                </div>
                            </div>
                            <div class="am-form-group">
                                <label class="am-u-sm-2 am-form-label form-require"> 年龄 </label>
                                <div class="am-u-sm-10">
                                    <input type="text" class="tpl-form-input" readonly name="age" maxlength="30" value="<?php echo htmlentities($data['age']); ?>">
                                </div>
                            </div>
                            <div class="am-form-group">
                                <label class="am-u-sm-2 am-form-label form-require"> 健康状况 </label>
                                <div class="am-u-sm-10">
                                    <input readonly type="radio" value="1" name="health" <?php if($data['health'] == 1): ?> checked<?php endif; ?>> 健康
                                    <input readonly type="radio" value="2" name="health" <?php if($data['health'] == 2): ?> checked<?php endif; ?>> 一般(无慢性、传染性疾病)
                                    <input readonly type="radio" value="3" name="health" <?php if($data['health'] == 3): ?> checked<?php endif; ?>> 体弱(无慢性、传染性疾病)
                                    <input readonly type="radio" value="4" name="health" <?php if($data['health'] == 4): ?> checked<?php endif; ?>> 有无慢性、传染性疾病)
                            ...
                            <div class="am-form-group">
                                ...
                                <div class="am-u-sm-10">
                                    <label class="am-radio-inline">
                                        <input readonly type="radio" value="1" name="status"<?php if($data['status'] == 1): ?> checked<?php endif; ?>> 正常
                                    </label>
                                    <label class="am-radio-inline">
                                        <input readonly type="radio" value="0" name="status"<?php if($data['status'] == 0): ?> checked<?php endif; ?>> 未审核
                                    </label>
                                    <label class="am-radio-inline">
                                        <input readonly type="radio" value="2" name="status"<?php if($data['status'] == 2): ?> checked<?php endif; ?>> 未通过审核
                                    </label>
                                </div>
                            </div>
                            <div class="am-form-group">
                                <label class="am-u-sm-3 am-u-lg-2 am-form-label form-require">等级考核 </label>
                                <div class="am-u-sm-9 am-u-end"><?php echo $levelSelectStr; ?></div>
                            </div>
                            ...
                            <div class="am-form-group">
                                <div class="am-u-sm-10 am-u-sm-push-2 am-margin-top-lg">
                                    ...
                                    <button id="btn-submit" type="button" class="j-submit am-btn am-btn-secondary" onclick="TF_Volunteer._submit('<?php echo htmlentities($workUrl); ?>')">确认提交</button>
                                </div>
                            </div>
                            <?php endif; ?>
                        </fieldset>
