                        ...
                        <fieldset>
                            ...
                            <div class="am-form-group">
                                ...
                                <div class="am-u-sm-10">
                                    <input type="text" class="tpl-form-input"  name="title"  value="<?php echo htmlentities($data['title']); ?>">
                                </div>
                            </div>
                            <div class="am-form-group">
                                <label class="am-u-sm-2 am-form-label form-require"> 招募人数 </label>
                                <div class="am-u-sm-10">
                                    <input type="text" class="tpl-form-input"  name="number"  value="<?php echo htmlentities($data['number']); ?>">
                                </div>
                            </div>
                            <div class="am-form-group">
                                <label class="am-u-sm-2 am-form-label form-require"> 举办地址 </label>
                                <div class="am-u-sm-10">
                                    <input type="text" class="tpl-form-input"  name="address"  value="<?php echo htmlentities($data['address']); ?>">
                                </div>
                            </div>
                            <div class="am-form-group">
                                <label class="am-u-sm-2 am-form-label form-require"> 开始时间 </label>
                                <div class="am-u-sm-10">
                                    <input type="text" id="picker_begin_time" class="tpl-form-input"  name="begin_time"  value="<?php echo htmlentities($data['begin_time']); ?>">
                                </div>
                            </div>
                            <div class="am-form-group">
                                <label class="am-u-sm-2 am-form-label form-require"> 结束时间 </label>
                                <div class="am-u-sm-10">
                                    <input type="text" id="picker_end_time" class="tpl-form-input" name="end_time"  value="<?php echo htmlentities($data['end_time']); ?>">
                                </div>
                            </div>
                            <div class="am-form-group">
                                <label class="am-u-sm-2 am-form-label form-require"> 报名开始时间 </label>
                                <div class="am-u-sm-10">
                                    <input type="text" class="tpl-form-input" id="picker_join_begin"  name="join_begin"  value="<?php echo htmlentities($data['join_begin']); ?>">
                                </div>
                            </div>
                            <div class="am-form-group">
                                <label class="am-u-sm-2 am-form-label form-require"> 报名结束时间 </label>
                                <div class="am-u-sm-10">
                                    <input type="text" class="tpl-form-input" id="picker_join_end" name="join_end"  value="<?php echo htmlentities($data['join_end']); ?>">
                                </div>
                            </div>
                            <div class="am-form-group">
                            ...
                            <div class="am-form-group">
                                ...
                                <div class="am-u-sm-10">
                                    ...
                                    <label class="am-radio-inline">
                                        <input type="radio" value="1" name="status"<?php if($data['status'] == 1): ?> checked<?php endif; ?>> 审核通过
                                    </label>
                                    <label class="am-radio-inline">
                            ...
                            <div class="am-form-group">
                                <div class="am-u-sm-10 am-u-sm-push-2 am-margin-top-lg">
                                    ...
                                    <button id="btn-submit" type="button" class="j-submit am-btn am-btn-secondary" onclick="TF_VolunteerActivity._submit('<?php echo htmlentities($workUrl); ?>')">确认提交</button>
                                </div>
                            </div>
                            <?php endif; ?>
                        </fieldset>
