                    ...
                    <div class="am-scrollable-horizontal am-u-sm-12">
                        <table width="100%" class="am-table am-table-compact am-table-striped tpl-table-black am-text-nowrap">
                            ...
                            <tr>
                                ...
                                <td class="am-text-middle"><?php echo htmlentities($item['age']); ?></td>
                                ...
                                <td class="am-text-middle">
                                    <div class="tpl-table-black-operation">
                                        ...
                                        <?php endif; ?>
                                        <a href="<?php echo htmlentities($examineUrl); ?><?php echo htmlentities($item['id']); ?>">
                                            <i class="am-icon-pencil-square-o"></i>考核
                                        </a>
                                        <a href="#">
                                            <i class="am-icon-columns"></i>日志
                                        </a>
                                        <a href="<?php echo htmlentities($rewardUrl); ?><?php echo htmlentities($item['id']); ?>" >
