                        ...
                        <div class="am fr ">
                            ...
                            <div class="am-form-group am-fl">
                                <div class="am-input-group am-input-group-sm tpl-form-border-form">
                                    <input type="text" class="am-form-field" name="sword" placeholder="请输入课程标题" value="<?php echo htmlentities($searchWord); ?>">
                            ...
                            <tr>
                                ...
                                <td class="am-text-middle">
                                    ...
                                    <?php elseif($item['status']==3): ?>
                                        <span class="am-text-success">已发布</span>
                                    <?php elseif($item['status']==4): ?>
                                        <span class="am-text-danger">已下架</span>
                                    <?php endif; ?>
                                </td>
                                <td class="am-text-middle">
