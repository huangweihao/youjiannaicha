<?php /*a:4:{s:78:"/Users/huang/Documents/project/jining/xingzhengguanli/app/view/advert/work.tpl";i:1604487493;s:73:"/Users/huang/Documents/project/jining/xingzhengguanli/app/view/layout.tpl";i:1604486725;s:87:"/Users/huang/Documents/project/jining/xingzhengguanli/app/view/upload/tpl_file_item.tpl";i:1590067177;s:86:"/Users/huang/Documents/project/jining/xingzhengguanli/app/view/upload/file_library.tpl";i:1590067177;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    <meta charset="utf-8"/>
                    ...
                    <div class="widget-body">
                        <fieldset>
                            <div class="widget-head am-cf">
                                <div class="widget-title am-fl"><?php echo htmlentities($columnName); ?></div>
                                <div class="am-fr"><a href="<?php echo htmlentities($viewUrl); ?>" class="am-btn am-btn-primary am-btn-xs"><span class="am-icon-reply"></span> 返回列表</a></div>
                            </div>
                            <div class="am-form-group">
                                <label class="am-u-sm-2 am-form-label form-require"> 名称 </label>
                                <div class="am-u-sm-10">
                                    <input type="text" class="tpl-form-input" name="name"  value="<?php echo htmlentities($data['name']); ?>">
                                </div>
                            </div>
                            <div class="am-form-group">
                                <label class="am-u-sm-3 am-u-lg-2 am-form-label form-require">类型 </label>
                                <div class="am-u-sm-9 am-u-end"><?php echo $typeSelectHtml; ?></div>
                            </div>
                            <div class="am-form-group">
                                <label class="am-u-sm-2 am-form-label form-require"> url </label>
                                <div class="am-u-sm-10">
                                    <input type="text" class="tpl-form-input" name="url"  value="<?php echo htmlentities($data['url']); ?>">
                                </div>
                            </div>
                            <div class="am-form-group">
                                <label class="am-u-sm-2 am-form-label form-require"> 价格(元) </label>
                                <div class="am-u-sm-10">
                                    <input type="text" class="tpl-form-input" name="price"  value="<?php echo htmlentities($data['price']); ?>">
                                </div>
                            </div>

                            <div class="am-form-group">
                                <label class="am-u-sm-2 am-form-label form-require"> 投放时间 </label>
                                <div class="am-u-sm-10">
                                    <input type="text" id="picker_begin_time" class="tpl-form-input" name="publish_time"  value="<?php echo htmlentities($data['publish_time']); ?>">
                                </div>
                            </div>
                            <div class="am-form-group">
                                <label class="am-u-sm-2 am-form-label" style="position: sticky;">简介 </label>
                                <div class="am-u-sm-10">
                                    <textarea type="text" class="tpl-form-input" name="desc" > <?php echo htmlentities($data['desc']); ?></textarea>
                                </div>
                            </div>
                            <div class="am-form-group">
                                    ...
                                    <div class="am-form-file">
                                        <div class="am-form-file">
                                            ...
                                            <div class="uploader-list am-cf">
                                                ...
                                                <div class="file-item">
                                                    <a href="<?php echo htmlentities($data['cover']); ?>" title="点击查看大图" target="_blank">
                                                        <img src="<?php echo htmlentities($data['cover']); ?>">
                                                    </a>
                                                    <input type="hidden" name="cover" value="<?php echo htmlentities($data['cover']); ?>"> <i class="iconfont icon-shanchu file-item-delete"></i>
                                                </div>
                                                <?php endif; ?>
                                            </div>
                                        </div>
                            ...
                            <div class="am-form-group">
                                <label class="am-u-sm-2 am-form-label form-require"> 内容 </label>
                                <div class="am-u-sm-10" style="position: sticky;">
                                    <textarea name="content" id="content" cols="30" rows="10"><?php echo htmlentities($data['content']); ?></textarea>
                                </div>
                            </div>
                            ...
                            <div class="am-form-group">
                                ...
                                <div class="am-u-sm-10">
                                    <label class="am-radio-inline">
                                        <input type="radio" value="0" name="status"<?php if($data['status'] == 0): ?> checked<?php endif; ?>> 待审核
                                    </label>
                                    <label class="am-radio-inline">
                                        <input type="radio" value="1" name="status" <?php if($data['status'] == 1): ?> checked<?php endif; ?>> 通过审核
                                    </label>
                                    <label class="am-radio-inline">
                                        <input type="radio" value="2" name="status" <?php if($data['status'] == 2): ?> checked<?php endif; ?>> 未通过审核
                                    </label>
                                    <label class="am-radio-inline">
                                        <input type="radio" value="3" name="status" <?php if($data['status'] == 3): ?> checked<?php endif; ?>> 已发布
                                    </label>
                                    <label class="am-radio-inline">
                                        <input type="radio" value="4" name="status" <?php if($data['status'] == 4): ?> checked<?php endif; ?>> 已下架
                                    </label>
                                </div>
                            </div>
                            <?php if($columnPower['insert'] || $columnPower['update']): ?>
                            <div class="am-form-group">
                                <div class="am-u-sm-10 am-u-sm-push-2 am-margin-top-lg">
                                    <input type="hidden" name="key" value="<?php echo htmlentities($data['id']); ?>">
                                    <button id="btn-submit" type="button" class="j-submit am-btn am-btn-secondary" onclick="TF_Advert._submit('<?php echo htmlentities($workUrl); ?>')">确认提交</button>
                                </div>
                            </div>
                            <?php endif; ?>
                        </fieldset>
