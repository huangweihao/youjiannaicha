        ...
        <div class="am-u-sm-12 am-u-md-12 am-u-lg-12">
            <div class="widget am-cf">
                ...
                <div class="am-u-sm-12 am-u-md-8 page_toolbar" style="width: 100%;">
                    <div class="am fr">
                        <form method="get" class="sub" name="search" id="sform" action="<?php echo htmlentities($searchUrl); ?>">
                            <?php echo $groupSelectStr; ?>
                            <?php echo $workSelectStr; ?>
                    ...
                    <div class="am-scrollable-horizontal am-u-sm-12" >
                        <table width="100%" class="am-table am-table-compact am-table-striped tpl-table-black am-text-nowrap">
                            ...
                            <tr>
                                ...
                                <td class="am-text-middle"><?php echo htmlentities(date("Y-m-d H:i:s",!is_numeric($item['ctime'])? strtotime($item['ctime']) : $item['ctime'])); ?></td>
                            </tr>
                            <?php endforeach; ?>
                            </tbody>
                        </table>
