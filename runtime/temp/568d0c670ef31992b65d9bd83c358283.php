                        ...
                        <fieldset>
                            ...
                            <div class="am-form-group">
                                <div class="am-u-sm-10 am-u-sm-push-2 am-margin-top-lg">
                                    ...
                                    <button id="btn-submit" type="button" class="j-submit am-btn am-btn-secondary" onclick="TF_ArticleType._submit('<?php echo htmlentities($workUrl); ?>')">确认提交</button>
                                </div>
                            </div>
                            <?php endif; ?>
                        </fieldset>
