<?php /*a:4:{s:90:"/Users/huang/Documents/project/jining/xingzhengguanli/app/view/volunteer_activity/show.tpl";i:1604044734;s:73:"/Users/huang/Documents/project/jining/xingzhengguanli/app/view/layout.tpl";i:1604029607;s:87:"/Users/huang/Documents/project/jining/xingzhengguanli/app/view/upload/tpl_file_item.tpl";i:1590067177;s:86:"/Users/huang/Documents/project/jining/xingzhengguanli/app/view/upload/file_library.tpl";i:1590067177;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    <meta charset="utf-8"/>
    ...
    <?php if(in_array($columnAction,['i','e'])): ?>
        ...
        <div class="am-u-sm-12 am-u-md-12 am-u-lg-12">
            <div class="widget am-cf">
                ...
                <div class="widget-head am-cf">
                    <div class="widget-title a m-cf"><?php echo htmlentities($activity_name); ?>--排班列表</div>
                </div>
                    ...
                    <div class="am-scrollable-horizontal am-u-sm-12" >
                        <table width="100%" class="am-table am-table-compact am-table-striped tpl-table-black am-text-nowrap">
                            ...
                            <tr>
                                ...
                                <td class="am-text-middle"><?php echo htmlentities($item['users']); ?></td>
                                <td class="am-text-middle"><?php echo htmlentities($item['schedule_begin']); ?></td>
                                <td class="am-text-middle"><?php echo htmlentities($item['schedule_end']); ?></td>
...
<?php if(in_array($columnAction,['choose'])): ?>
    ...
    <?php endif; if(in_array($columnController,['Train','VolunteerActivity','Shop','ActivityTemplate','Huibendi']) && in_array($columnAction,['i','e','show','schedule'])): ?>
    <script>
        IMGUP_URL = '<?php echo htmlentities($uploadUrl); ?>';
        <?php if(in_array($columnController,['VolunteerActivity','ShopPool']) && in_array($columnAction,['i','e','schedule'])): ?>
...
<script id="tpl-group-item" type="text/template">
    ...
    <script>
        <?php if(in_array($columnController,['Train','VolunteerActivity']) && in_array($columnAction,['i','e','show','schedule'])): ?>
        $(function () {
            UM.getEditor('remark', {
            ...
            uploader.on( 'uploadSuccess', function( file, e ) {
                if (e.file_id != ''){
                    $('#video').append("<input type='text' class='tpl-form-input' name='video' value='"+e.file_path+"'>");
