                    ...
                    <div class="widget-body">
                        <fieldset>
                            ...
                            <div class="am-form-group">
                                ...
                                <div class="am-u-sm-10">
                                    <input type="text" class="tpl-form-input" name="author"  value="<?php echo htmlentities($data['author']); ?>">
                                </div>
                            </div>
                            <div class="am-form-group">
                                <label class="am-u-sm-2 am-form-label"> 简介 </label>
                                <div class="am-u-sm-10">
                                    <textarea type="text" class="tpl-form-input" name="desc" maxlength="120" ><?php echo htmlentities($data['desc']); ?></textarea>
                                </div>
                            </div>
                            <div class="am-form-group">
                            ...
                            <div class="am-form-group">
                                ...
                                <div class="am-u-sm-10">
                                    <textarea type="text" class="tpl-form-input" id="content" name="content" ><?php echo htmlentities($data['content']); ?></textarea>
                                </div>
                            </div>
                            <div class="am-form-group ">
                            ...
                            <div class="am-form-group">
                                <div class="am-u-sm-10 am-u-sm-push-2 am-margin-top-lg">
                                    ...
                                    <button id="btn-submit" type="button" class="j-submit am-btn am-btn-secondary" onclick="TF_Train._submit('<?php echo htmlentities($workUrl); ?>')">确认提交</button>
                                </div>
                            </div>
                            <?php endif; ?>
                        </fieldset>
