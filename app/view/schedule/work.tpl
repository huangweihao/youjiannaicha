                    ...
                    <div class="widget-body">
                        <fieldset>
                            ...
                            <div class="am-form-group">
                                ...
                                <div class="am-u-sm-10">
                                    <input type="text"  class="tpl-form-input" readonly  value="<{$data['schedule_title']}>" name="schedule_title" >
                                </div>
                            </div>
                            <div class="am-form-group">
                                <label class="am-u-sm-2 am-form-label form-require"> 排班开始时间 </label>
                                <div class="am-u-sm-10">
                                    <input type="text" id="picker_schedule_begin" readonly  class="tpl-form-input" value="<{$data['schedule_begin']}>"  name="schedule_begin" >
                                </div>
                            </div>
                            <div class="am-form-group">
                                <label class="am-u-sm-2 am-form-label form-require"> 排班结束时间 </label>
                                <div class="am-u-sm-10">
                                    <input type="text" id="picker_schedule_end" readonly  class="tpl-form-input" value="<{$data['schedule_end']}>" name="schedule_end" >
                                </div>
                            </div>
                            <div class="am-form-group">
                                <label class="am-u-sm-2 am-form-label form-require"> 选择用户 </label>
                                <div class="am-u-sm-10">
                                    <button style="margin-left: 10px;" type="button" disabled onclick="TB_Common._OpenBig(this,'/user/choose')" data-i="<{$data['activity_id']}>" data-n="排班" class="am-btn am-btn-success">选择用户</button>
                                </div>
                            </div>
                            <div class="am-form-group">
                                ...
                                <div class="am-u-sm-10" id="chooseShowUser">
                                    <{if !empty($data['users'])}>
                                        <{foreach $data['users'] as $item}>
                                            <div style="margin-left: 10px;" class="am-btn am-btn-success"><{$item}></div>
                                        <{/foreach}>
                                    <{/if}>
                                </div>
                                <input type="hidden" name="user_id" value="<{$data['user_id']}>" id="chooseUser">
                            </div>
                            ...
                            <div class="am-form-group">
                                <div class="am-u-sm-10 am-u-sm-push-2 am-margin-top-lg">
                                    ...
                                    <button id="btn-submit" disabled type="button" class="j-submit am-btn am-btn-secondary" onclick="TF_Schedule._submit('<{$workUrl}>')">确认提交</button>
                                </div>
                            </div>
                            <{/if}>
                        </fieldset>
