                        ...
                        <fieldset>
                            ...
                            <div class="am-form-group">
                                ...
                                <div class="am-u-sm-10">
                                    <input type="text" class="tpl-form-input" name="name"  value="<{$data['name']}>">
                                </div>
                            </div>
                            <div class="am-form-group">
                            ...
                            <div class="am-form-group">
                                ...
                                <div class="am-u-sm-10">
                                    <input type="text" class="tpl-form-input" name="url"  value="<{$data['url']}>">
                                </div>
                            </div>
                            <div class="am-form-group">
                                <label class="am-u-sm-2 am-form-label form-require"> 价格(元) </label>
                                <div class="am-u-sm-10">
                                    <input type="text" class="tpl-form-input" name="price"  value="<{$data['price']}>">
                                </div>
                            </div>
                            ...
                            <div class="am-form-group">
                                ...
                                <div class="am-u-sm-10">
                                    <input type="text" id="picker_begin_time" class="tpl-form-input" name="publish_time"  value="<{$data['publish_time']}>">
                                </div>
                            </div>
                            <div class="am-form-group">
                            ...
                            <div class="am-form-group">
                                ...
                                <div class="am-u-sm-10">
                                    ...
                                    <label class="am-radio-inline">
                                        <input type="radio" value="3" name="status" <{if $data['status'] == 3}> checked<{/if}>> 已发布
                                    </label>
                                    <label class="am-radio-inline">
                                        <input type="radio" value="4" name="status" <{if $data['status'] == 4}> checked<{/if}>> 已下架
                                    </label>
                                </div>
                            </div>
                            ...
                            <div class="am-form-group">
                                <div class="am-u-sm-10 am-u-sm-push-2 am-margin-top-lg">
                                    ...
                                    <button id="btn-submit" type="button" class="j-submit am-btn am-btn-secondary" onclick="TF_Advert._submit('<{$workUrl}>')">确认提交</button>
                                </div>
                            </div>
                            <{/if}>
                        </fieldset>
