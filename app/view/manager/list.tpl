            ...
            <div class="widget am-cf">
                ...
                <div class="widget-body am-fr">
                    ...
                    <div class="am-u-sm-12 am-u-md-9 page_toolbar">
                        <div class="am fr">
                            <form method="get" class="sub" name="search" action="<{$searchUrl}>">
                            <{$roleSelectStr|raw}>
                            <div class="am-form-group am-fl">
                                <div class="am-input-group am-input-group-sm tpl-form-border-form">
                                    <input type="text" class="am-form-field" name="sword" placeholder="请输入管理员名称" value="<{$searchWord}>">
                        ...
                        <table width="100%" class="am-table am-table-compact am-table-striped tpl-table-black am-text-nowrap">
                            ...
                            <{foreach $data['data'] as $key=>$item }>
                                <tr>
                                    ...
                                    <td class="am-text-middle"><{$roleData[$item['role_id']] ? $roleData[$item['role_id']]:'-'}></td>
                                    ...
                                    <td class="am-text-middle">
                                        <div class="tpl-table-black-operation">
                                            ...
                                            <{/if}>
                                            <{if $columnPower['other']}>
                                            <a href="<{$logOpenUrl|raw}>" data-i="<{$item['id']}>" data-n="<{$item['name']}>-登录详情">
