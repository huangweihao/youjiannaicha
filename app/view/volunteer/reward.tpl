                    ...
                    <div class="widget-body">
                        <fieldset>
                            ...
                            <div class="am-form-group">
                                ...
                                <div class="am-u-sm-10">
                                    <input type="text" class="tpl-form-input" readonly name="age" maxlength="30" value="<{$data['age']}>">
                                </div>
                            </div>
                            <div class="am-form-group">
                                <label class="am-u-sm-2 am-form-label form-require"> 健康状况 </label>
                                <div class="am-u-sm-10">
                                    <input readonly type="radio" value="1" name="health" <{if $data['health'] == 1}> checked<{/if}>> 健康
                                    <input readonly type="radio" value="2" name="health" <{if $data['health'] == 2}> checked<{/if}>> 一般(无慢性、传染性疾病)
                                    <input readonly type="radio" value="3" name="health" <{if $data['health'] == 3}> checked<{/if}>> 体弱(无慢性、传染性疾病)
                                    <input readonly type="radio" value="4" name="health" <{if $data['health'] == 4}> checked<{/if}>> 有无慢性、传染性疾病)
                            ...
                            <div class="am-form-group">
                                ...
                                <div class="am-u-sm-10">
                                    <label class="am-radio-inline">
                                        <input readonly type="radio" value="1" name="status"<{if $data['status'] eq 1}> checked<{/if}>> 正常
                                    </label>
                                    <label class="am-radio-inline">
                                        <input readonly type="radio" value="0" name="status"<{if $data['status'] eq 0}> checked<{/if}>> 未审核
                                    </label>
                                    <label class="am-radio-inline">
                                        <input readonly type="radio" value="2" name="status"<{if $data['status'] eq 2}> checked<{/if}>> 未通过审核
                                    </label>
                                </div>
                            </div>
                            <div class="am-form-group">
                                <label class="am-u-sm-3 am-u-lg-2 am-form-label form-require">等级考核 </label>
                                <div class="am-u-sm-9 am-u-end"><{$rewardSelectStr|raw}></div>
                            </div>
